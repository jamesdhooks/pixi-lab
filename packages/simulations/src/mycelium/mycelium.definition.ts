...
export const myceliumDefinition: SimulationDefinition = {
  ...
  modes: [
    { id: 'paint', label: 'Paint', icon: '✎', description: 'Paint new growth onto the surface.' },
  ],
  gestureMap: { tap: 'paint a new growth spot', drag: 'paint wider growth along your path' },
  ...
  tutorialPages: [
    { icon: '✎', title: 'Paint Threads', body: 'Tap to seed a colony or drag to lay down a wider band of hyphae.' },
