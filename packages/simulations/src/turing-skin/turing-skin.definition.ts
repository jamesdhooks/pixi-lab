...
export const turingSkinDefinition: SimulationDefinition = {
  ...
  kind: 'simulation',
  name: 'Turing Skin',
  short: 'Paint living pigment and let chemistry settle into spots, stripes, and scars.',
  long: 'A raw WebGL reaction-diffusion playground. Paint pigment into the surface, erase holes, then tune growth, breakup, and spread until the chemistry organizes into animal-skin patterns.',
  ...
  modes: [
    { id: 'paint', label: 'Paint', icon: '+', description: 'Add pigment that grows into spots or bands.' },
    { id: 'erase', label: 'Erase', icon: '-', description: 'Cut pale holes that the chemistry slowly repairs.' },
  ],
  gestureMap: { tap: 'apply the selected chemistry tool', drag: 'paint with the selected chemistry tool', hold: 'sustain the selected chemistry tool', fast_swipe: 'apply a stronger selected chemistry tool' },
