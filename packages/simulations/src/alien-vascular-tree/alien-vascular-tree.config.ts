...
export const ALIEN_VASCULAR_TREE_SETTINGS_FIELDS: SettingsField[] = [
  ...
  { key: 'resolution', label: 'Resolution', section: 'Simulation', type: 'number', min: 64, max: 1024, step: 1, numericScale: 'powerOfTwo', default: 128 },
  { key: 'branchBudget', label: 'Branch Budget', section: 'Growth', type: 'number', min: 64, max: 1024, step: 1, numericScale: 'powerOfTwo', default: 256 },
