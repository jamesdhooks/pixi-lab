...
export const alienVascularTreeDefinition: SimulationDefinition = {
  ...
  modes: [
    { id: 'guide', label: 'Guide', icon: '*', description: 'Move the guide point for new growth.' },
    { id: 'feed', label: 'Feed', icon: '+', description: 'Thicken nearby vessels.' },
    { id: 'prune', label: 'Prune', icon: '-', description: 'Trim nearby branch tips.' },
  ],
  gestureMap: { tap: 'apply Guide, Feed, or Prune at the pointer', drag: 'paint the active vascular tool along your path' },
  ...
  tutorialPages: [
    ...
    { icon: '-', title: 'Prune Tips', body: 'Switch to Prune and tap or drag over branch tips to trim them back.' },
  ],
};
