...
const PARAM_PRESETS: Array<{
  ...
  { launchPower: 880, launchSpread: 0.12, shellFuse: 1.12, gravity: 320, airDrag: 0.22, burstParticles: 320, explosionPower: 330, secondaryChance: 0.34, secondaryDepth: 1, secondaryScale: 0.5, crackleIntensity: 0.54, particleSize: 1.28, trailFade: 0.92, bloomStrength: 1.58, autoFinaleRate: 2.1 },
  { launchPower: 1160, launchSpread: 0.28, shellFuse: 1.52, gravity: 410, airDrag: 0.42, burstParticles: 544, explosionPower: 440, secondaryChance: 0.56, secondaryDepth: 2, secondaryScale: 0.58, crackleIntensity: 0.9, particleSize: 1.62, trailFade: 0.944, bloomStrength: 2.05, autoFinaleRate: 3.2 },
  { launchPower: 1380, launchSpread: 0.42, shellFuse: 1.84, gravity: 520, airDrag: 0.72, burstParticles: 960, explosionPower: 570, secondaryChance: 0.72, secondaryDepth: 3, secondaryScale: 0.44, crackleIntensity: 1.22, particleSize: 1.96, trailFade: 0.965, bloomStrength: 2.72, autoFinaleRate: 4.6 },
  { launchPower: 720, launchSpread: 0.08, shellFuse: 0.9, gravity: 260, airDrag: 0.16, burstParticles: 224, explosionPower: 260, secondaryChance: 0.24, secondaryDepth: 1, secondaryScale: 0.62, crackleIntensity: 0.42, particleSize: 1.06, trailFade: 0.89, bloomStrength: 1.34, autoFinaleRate: 1.5 },
];
